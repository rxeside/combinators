...
export declare const getFloatingOneTapTemplate: ({ scheme, indent, openFullAuth, close, lang, contentId, appName, providers, renderOAuthList, }: FloatingOneTapTemplateParams) => (id: string) => string;
export {};
